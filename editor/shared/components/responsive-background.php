...
function renderBackgroundSettings($opts, $device) {
    ...
    if ($opts['showImage']) {
        ...
        $html .= '<input type="url" class="settings-input text-xs flex-1 border border-gray-300 rounded-lg px-3 py-2" placeholder="https://example.com/image.jpg"';
        ...
        $html .= '<select class="settings-input text-xs w-full border border-gray-300 rounded-lg px-3 py-2" data-path="' . $basePath . '.background-size" data-responsive="true">';
        ...
        $html .= '<select class="settings-input text-xs w-full border border-gray-300 rounded-lg px-3 py-2" data-path="' . $basePath . '.background-repeat" data-responsive="true">';
    ...
    if ($opts['showGradient']) {
        ...
        $html .= '<select class="settings-input text-xs w-full border border-gray-300 rounded-lg px-3 py-2" data-path="' . $basePath . '.gradient-direction" data-responsive="true">';
    ...
    if ($opts['showVideo']) {
        ...
        $html .= '<input type="url" class="settings-input text-xs w-full border border-gray-300 rounded-lg px-3 py-2" placeholder="https://example.com/video.mp4"';
